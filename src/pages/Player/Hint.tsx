...
const exampleText = `[5]----- Payne didn’t ---- -- was ---- ----- one --- -- --- ------ grade ", "[10]", "-- --- -------- -- ---- ---- - --------- --- ---- ----- --- --- ------ --- cashier --- ", "[20]", "--- --- ------ ---- ---- ----- --- ---- a ---------- ", "[25]", "------- -- his lunch --- always ----- ", "[30]", "----- never -------- ---- ---- -------- ---- --- their ------ -- ", "[35]", "suddenly ---- ----- In financial ------ ", "[40]", "----- --- -- ------ than --- --- ------- --- -- --- ", "[45]", "-------- --------- himself -- ---- --- ---- ------ ---- -- ", "[50]", "--- ---- -- ----- die -- ------ ", "[150]", "-- --- ---- ", "[55]", "-- come ----- ---- -- ---- --- -------- --- ----- --- --- --- -- ------- -- ------ -- ---- ", "[65]", "indicated -- the ----- ---- -- --- - ---- ------- ", "[70]", "------ ---- ---- -- ------- -- --- --- ---- -- everyone ", "[75]", "--- -- --- -- -------- ---- --- ----- ", "[80]", "--- kept --- distance ---- --------- ----- ------ -- ", "[85]", "--- ------- ----- changed --- ------- --- ---- ", "[90]", "----- -- now - --------- -- social ----------- ", "[95]", "-- -------- --- -- --- ↵----- ------ about being ---- ", "[100]", "is feeling ----- ------- ---- carries ------ ------ ", "[105]", "Comparing -------- -- ------ who ---- ---- leads -- ------ -- ------- ----- -- ----- ", "[115]", "--- lead -- -------- --- ---- and ------- ------ ", "[120]", "-- --- ---- lead -- - ----------- ------ ----- - ", "[125]", "--- ------- -------- ----- says ---- ", "[130]", "-- --- ---------- -- ------- --------- to ------ n…----- --- ---- -- ----- He - ----- -- an example ", "[140]", "-- air ------- ---- ---------- ------ economy ----… ------- --------- ---- --- --------- ---- ↵face ", "[155]", "to ---- ---- ------ ------ -- the ", "[160]", "------- ------- ---- --- ---- ------- Poor ", "[165]", "people are ---- ---- likely -- take greater ----- ", "[170]", "---- -------- to ------ --- ------------ loans ", "[175]", "----- some --- ---- people --- poor ------- -- --- --- ", "[180]", "choices ---- ----- ----- ---- it’s ------ --- other --- ------- ", "[185]", "---- make --- ------- ------- they ---- ---- have ", "[190]", "------- to ----- ----- ", "[145]", "---- ---- -------- ", "[195]", "-- -- ----- -- only half -- --- -------- ", "[200]", "--- ------ picture -- --- -- ----------- --------- ", "[205]", "------- -- ----- ------ -- --- --- --- ------ -- ↵-------- ", "[210]", "--- --- --- ------- --- ---- --- poor -- ---- --------- ", "[215]", "is ------- out of hand ----- ---- -- doesn’t ", "[220]", "---- --- ------- --- --------- ---- -- ---- about ---------- ", "[225]", "-- -- ↵-- ---- -- ---- our --------- ------ --- --- ------` 
    ...
    return <StyldView>
        {
            hintObjects.map(object=>{
                if(object.time * 1000 < position.position){
